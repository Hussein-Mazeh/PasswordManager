...
(function runAutofill() {
    function locateFields() {
        ...
        if (form) {
            const candidates = Array.from(form.querySelectorAll('input[type="text"], input[type="email"], input[type="username"], input[name*="user" i], input[name*="email" i]'));
